        ...
        <section className="hero-surface">
          <div className="hero-grid surface-pad">
            <div className="page-stack" style={{ gridColumn: '1 / -1' }}>
              ...
              <div className="journey-flow" aria-label="Agent workflow">
                <div className="journey-step">
                  ...
                  <div className="journey-step__body">
                    ...
                    <div className="journey-step__title">
                      Provision paid endpoint
                    </div>
                    <p className="journey-step__copy">
                      Create the MPP-protected gateway URL the buyer agent will call.
                    </p>
                  </div>
                </div>
                ...
                <div className="journey-step">
                  ...
                  <div className="journey-step__body">
                    ...
                    <p className="journey-step__copy">
                      Top up the agent with funds so it can satisfy the payment challenge.
                    </p>
                  </div>
                </div>
                ...
                <div className="journey-step">
                  ...
                  <div className="journey-step__body">
                    ...
                    <div className="journey-step__title">
                      Agent pays and retrieves
                    </div>
                    <p className="journey-step__copy">
                      The agent pays the endpoint, clears the MPP challenge, and receives the upstream response immediately.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Space orientation="vertical" size={18} style={{ width: '100%' }}>
              <div className="section-heading">
                ...
                <p className="section-copy">
                  Paste an existing API URL to generate a paid endpoint.
                </p>
              </div>
            ...
            {generated ? (
              <Space orientation="vertical" size={18} style={{ width: '100%' }}>
                <div className="section-heading">
                  ...
                  <p className="section-copy">
                    Your paid endpoint is ready. Open the live page demo
                  </p>
                </div>
